      ...
      <div>
        <Router>
          ...
          <Routes>
            ...
            <Route exact path="/entertainment" element={<News setProgres={this.setProgres} apikey={this.apikey}  key="entertainment" pageSize={this.pageSize} country="in" category="entertainment" />} />
